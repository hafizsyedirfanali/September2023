...
public class CH15_AdvanceDelegates
{
    ...
    {
        public delegate void ServiceDelegate();//Application of Multidelegate
        public void Test()
        {
            bool smsService = false, emailService = false, whatsAppService = false;
            Console.WriteLine("Do you want to register for SMS service? press y or n"); smsService = Console.ReadLine() == "y";
            Console.WriteLine("Do you want to register for Email service? press y or n"); emailService = Console.ReadLine() == "y";
            Console.WriteLine("Do you want to register for WhatsApp service? press y or n"); whatsAppService = Console.ReadLine() == "y";
            ServiceDelegate services = () => { };
            if (smsService) services += () => { Console.WriteLine("SMS Service Registered"); };
            if (emailService) services += () => { Console.WriteLine("Email Service Registered"); };
            if (whatsAppService) services += () => { Console.WriteLine("Whatsapp Service Registered"); };
